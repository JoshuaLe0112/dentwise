...
function HowItWork() {
  return <section className = "relative py-32 px-6 outline-hidden z-10 max-w-7xl mx-auto ">
    ...
    <div className = "text-center mb-20">
      <div className = "inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-primary/5 to-primary/10 rounded-full border border-primary/10 backdrop-blur-sm mb-6">
        ...
        <p className ="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed ">
            Our streamlined process makes dental care accessible, convinient, and strees-free for everyone 
        </p>
    ...
    <div className = "relative">
        ...
        {/*CONNECTION */}
        <div className ="absolute top-1/2 left-0 right-0 h-px bg-gradient-to-r from-transparent via-primary/30 to-transparent transform -translate-y-1/2 hiddent lg:block"></div>
